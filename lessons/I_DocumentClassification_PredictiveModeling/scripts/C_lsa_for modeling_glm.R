...
# Bring in some data
carCorp <- VCorpus(DirSource("~/Desktop/Harvard_NLP_Student/lessons/I_DocumentClassification_PredictiveModeling/data/AutoAndElectronics/rec.autos"))
electronicCorp <- VCorpus(DirSource("~/Desktop/Harvard_NLP_Student/lessons/I_DocumentClassification_PredictiveModeling/data/AutoAndElectronics/sci.electronics"))
...
#saveRDS(lsaTDM, '~/Desktop/Harvard_NLP_Student/lessons/I_DocumentClassification_PredictiveModeling/data/lsaTDM_tfidf.rds') #be sure to declare the right wd!
