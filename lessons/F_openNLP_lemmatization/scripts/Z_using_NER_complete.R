...
#saveRDS(allData, 'allData_complete.rds')
...
#write.csv(locs, 'locs_complete.csv', row.names = F)
...
saveRDS(polTxt, 'polTxt_complete.rds')
polTxt <- readRDS('polTxt_complete.rds')
...
plot(plotDF$locPol, plotDF$locWC, main = '407 Trump Speeh NER top 10 Locations')
